...
gulp.task('html', ['styles'], function() {
    ...
    var cssChannel = lazypipe()
        .pipe(minifyCss)
        .pipe(replace, '../lib/bower_components/bootstrap/fonts/', '../fonts/');

    var htmlChannel = lazypipe()
        .pipe(minifyHtml);

    return gulp.src(['app/*.html','app/scripts/**/html/*.html'])
        .pipe(assets)
        ...
        .pipe(gulpif('**/scripts/**/html/*.html', htmlChannel()))
        .pipe(gulp.dest('dist'));
});
...
gulp.task('test', ['jshint', 'unit-test']);
